...
<FONT color="black"></b>
    ...
    <table class="fl-table">
        ...
        <tr>
            ...
            <th>Team</th>
            <th>Date Signed</th>
            <th>Player Information in brief</th>
        </tr>
        </thead>
        <tbody>
        <%while(rs.next())
        {
            %>
            <tr>
                <td><%=rs.getInt("idTeam") %></td>
                <td><%=rs.getString("strPlayer") %></td>
                <td><%=rs.getString("strTeam") %></td>
                <td><%=rs.getString("dateSigned") %></td>
                <td><%=rs.getString("strDescription") %></td>
            </tr>
            <%}%>
        <tbody>
    </table>            	   
