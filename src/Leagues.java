...
public class Leagues {
	...
	public Leagues() throws FileNotFoundException, IOException, ParseException 
	{
		...
		for(int i=0;i<n;i++) {
			...
			all_league[i].league_id= Integer.parseInt((String)obj.get("idLeague"));
			all_league[i].league_name = (String) obj.get("strLeague");
			all_league[i].league_sports = (String) obj.get("strSport");
			//ll_league[i].league_alt =  (String) obj.get("strLeagueAlternate");
